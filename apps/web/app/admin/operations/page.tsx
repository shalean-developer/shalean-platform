        ...
        <>
          ...
          <section className="grid gap-4 lg:grid-cols-2">
            <div className="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <div className="mt-3 space-y-2 text-sm text-zinc-700 dark:text-zinc-300">
                <p>
                  New applicants (today): <span className="font-semibold">{data.cleanerSupply.newApplicantsToday}</span>
                </p>
                <p>
                  Approved cleaners: <span className="font-semibold">{data.cleanerSupply.approvedCleaners}</span>
                </p>
                <p>
                  Active cleaners: <span className="font-semibold">{data.cleanerSupply.activeCleaners}</span>
                </p>
          ...
          <section className="grid gap-4 lg:grid-cols-2">
            <div className="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <div className="mt-3 space-y-2 text-sm text-zinc-700 dark:text-zinc-300">
                <p>
                  Active bookings (demand): <span className="font-semibold">{data.supplyDemand.demand}</span>
                </p>
                <p>
                  Available cleaners (supply): <span className="font-semibold">{data.supplyDemand.supply}</span>
                </p>
                <p>
                  Demand / Supply: <span className="font-semibold">{data.supplyDemand.ratio ?? "∞"}</span>
                </p>
                <p>
                  Avg surge multiplier: <span className="font-semibold">x{data.supplyDemand.avgSurgeMultiplier.toFixed(2)}</span>
                </p>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <div className="mt-3 space-y-2 text-sm text-zinc-700 dark:text-zinc-300">
                <p>
                  Avg time to assign: <span className="font-semibold">{data.dispatch.avgAssignMinutes} min</span>
                </p>
                <p>
                  Acceptance rate: <span className="font-semibold">{data.dispatch.acceptanceRate}%</span>
                </p>
                <p>
