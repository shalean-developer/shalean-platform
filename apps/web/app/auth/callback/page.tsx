      ...
      {phase === "linked" ? (
        <AuthCard>
          <div className="text-center">
            ...
            {showPasswordHint ? (
              <div className="mt-8 rounded-xl border border-zinc-200 bg-zinc-50 px-4 py-3 text-left text-sm text-zinc-700 dark:border-zinc-700 dark:bg-zinc-900/60 dark:text-zinc-200">
