...
/**
 * Marks the authenticated cleaner as en route (`en_route_at`, ON_MY_WAY).
 * Same server effect as `POST /api/cleaner/jobs/:id` with `{ "action": "en_route" }` or `POST /api/cleaner/bookings/:id/en-route`.
 */
