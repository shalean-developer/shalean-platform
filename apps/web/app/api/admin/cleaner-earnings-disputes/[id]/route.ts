...
export async function PATCH(request: Request, ctx: { params: Promise<{ id: string }> }) {
  ...
  // Resolving an operational dispute and changing cleaner financial entitlement
  // are separate authorities. Check adjustment authority before any database access.
