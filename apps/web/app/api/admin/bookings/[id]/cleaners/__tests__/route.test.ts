...
describe("GET /api/admin/bookings/[id]/cleaners", () => {
  beforeEach(() => {
...
describe("PUT /api/admin/bookings/[id]/cleaners", () => {
  beforeEach(() => {
    process.env.NEXT_PUBLIC_SUPABASE_URL = "https://test.supabase.co";
    process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY = "test-anon";
    process.env.ADMIN_EMAIL = "ops@example.com";
  ...
  it("returns 403 when user is not admin", async () => {
    const res = await PUT(
      new Request("http://localhost/test", {
        ...
        body: JSON.stringify({
          members: [{ cleanerId: "00000000-0000-4000-8000-000000000010", role: "lead" }],
        }),
      }),
      { params: Promise.resolve({ id: "00000000-0000-4000-8000-000000000002" }) },
    );
