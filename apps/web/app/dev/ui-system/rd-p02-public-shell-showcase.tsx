...
const shellRules = [
  ...
  { title: "Compatibility boundary", detail: "Other public routes may retain SiteHeader growth-action mode until separately normalized; the homepage uses the current auth-first visual mode." },
  ...
  return (
    <section className="mx-auto w-full max-w-[var(--ui-container-wide)] px-[var(--ui-page-gutter)] py-[var(--ui-space-10)]">
      <div className="mb-[var(--ui-space-6)]">
        ...
        <p className="mt-[var(--ui-space-2)] max-w-3xl text-[length:var(--ui-text-small)] leading-[var(--ui-leading-body)] text-muted-foreground">Current UI-system reference for the Shalean homepage header, shared public container and footer.</p>
      </div>
