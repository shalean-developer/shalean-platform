  ...
  return (
    <nav aria-label="Booking progress" className="w-full min-w-0">
      <ol className="relative mx-auto grid w-full max-w-3xl grid-cols-4">
        <li
          className="pointer-events-none absolute left-[12.5%] right-[12.5%] top-3.5 h-px bg-slate-200 sm:top-4"
          aria-hidden
        >
          <span
          ...
          return (
            <li key={step} className="relative z-10 flex min-w-0 justify-center">
              <button
                ...
                className={cn(
                  "group flex min-w-0 flex-col items-center gap-0.5 bg-transparent px-0.5 transition sm:gap-1 sm:px-3",
              ...
              >
                <div
                  className={cn(
                    "flex h-7 w-7 items-center justify-center rounded-full text-xs font-medium shadow-sm ring-2 ring-background transition-colors sm:h-8 sm:w-8 sm:text-sm",
                ...
                <span
                  className={cn(
                    "whitespace-nowrap text-[10px] font-medium leading-tight sm:text-xs",
