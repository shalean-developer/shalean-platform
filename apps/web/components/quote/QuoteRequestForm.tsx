...
} from "@/components/quote/QuoteRequestCatalogPicker";
...
export function QuoteRequestForm() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    if (selected.length === 0) {
      setError("Please select at least one service or add-on.");
      return;
    }
    ...
    return (
      <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-8 text-center shadow-sm">
        ...
        <p className="mt-2 text-sm leading-relaxed text-slate-600">
          ...
          call{" "}
          <a href="tel:0871535250" className="font-semibold text-blue-700 hover:underline">087 153 5250</a>.
        </p>
        <Link
          href="/book"
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-5 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
      <QuoteRequestCatalogPicker
        selected={selected}
