  ...
  return (
    ...
    >
      <MarketingSectionHeader
        ...
        eyebrowTone="brand"
        title="Rated by customers on Google"
        description="The homepage review figures use the same verified Google Business Profile aggregate as Shalean's structured data."
      />

      <div className="mt-[var(--ui-space-16)] grid gap-[var(--ui-space-6)] sm:grid-cols-2 xl:grid-cols-4">
        <article className="flex min-h-[360px] flex-col items-center rounded-[var(--ui-radius-marketing)] border border-[#f2e3b3] bg-[var(--marketing-surface-soft-yellow)] px-[var(--ui-space-6)] py-[var(--ui-space-10)] text-center text-foreground shadow-[var(--ui-shadow-md)] transition-transform duration-200 hover:-translate-y-1 dark:border-border">
        ...
        <article className="flex min-h-[360px] flex-col items-center rounded-[var(--ui-radius-marketing)] border border-[#f3d7de] bg-[var(--marketing-surface-soft-blush)] px-[var(--ui-space-6)] py-[var(--ui-space-10)] text-center text-foreground shadow-[var(--ui-shadow-md)] transition-transform duration-200 hover:-translate-y-1 dark:border-border">
          <div className="flex h-24 w-24 items-center justify-center rounded-full border border-[#f3d7de] bg-background shadow-[var(--ui-shadow-sm)]" aria-hidden>
            <MessageSquareText className="h-12 w-12 text-[var(--marketing-accent-rose)]" strokeWidth={1.55} />
          </div>
        ...
        <article className="flex min-h-[360px] flex-col items-center rounded-[var(--ui-radius-marketing)] border border-[#cde9e4] bg-[var(--marketing-surface-soft-aqua)] px-[var(--ui-space-6)] py-[var(--ui-space-10)] text-center text-foreground shadow-[var(--ui-shadow-md)] transition-transform duration-200 hover:-translate-y-1 dark:border-border">
          <div className="flex h-24 w-24 items-center justify-center rounded-full border border-[#cde9e4] bg-background shadow-[var(--ui-shadow-sm)]" aria-hidden>
            <ShieldCheck className="h-14 w-14 text-[var(--marketing-accent-teal)]" strokeWidth={1.5} />
          </div>
        ...
        <article className="flex min-h-[360px] flex-col items-center rounded-[var(--ui-radius-marketing)] border border-[#e2d8f4] bg-[var(--marketing-surface-soft-lavender)] px-[var(--ui-space-6)] py-[var(--ui-space-10)] text-center text-foreground shadow-[var(--ui-shadow-md)] transition-transform duration-200 hover:-translate-y-1 dark:border-border">
          <div className="flex h-24 w-24 items-center justify-center rounded-full border border-[#e2d8f4] bg-background shadow-[var(--ui-shadow-sm)]" aria-hidden>
            <ReceiptText className="h-12 w-12 text-[var(--marketing-accent-violet)]" strokeWidth={1.5} />
          </div>
