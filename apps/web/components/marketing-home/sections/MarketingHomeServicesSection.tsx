...
export function MarketingHomeServicesSection() {
  ...
  return (
    <HomeSection
      ...
      tone="muted"
      className="scroll-mt-24 md:py-[var(--ui-space-20)]"
    >
      <div className="grid gap-[var(--ui-space-12)] lg:grid-cols-2 lg:items-center lg:gap-[var(--ui-space-16)]">
        <div className="grid grid-cols-1 gap-[var(--ui-space-3)] sm:grid-cols-[minmax(0,1.12fr)_minmax(0,1fr)] sm:grid-rows-2">
          <div className="relative aspect-[4/3] overflow-hidden rounded-[var(--ui-radius-marketing)] border border-border bg-card shadow-[var(--ui-shadow-sm)] sm:row-span-2 sm:min-h-[340px] sm:aspect-auto">
            <Image
          ...
          <div className="relative aspect-[16/10] overflow-hidden rounded-[var(--ui-radius-marketing)] border border-border bg-card shadow-[var(--ui-shadow-sm)]">
            <Image
        ...
        <div>
          <MarketingSectionHeader
            ...
            eyebrowTone="brand"
            title="Professional cleaning built around real homes and workplaces"
            description="From regular home cleaning to deep cleans, moves, offices, Airbnb turnovers and carpets, the team works to the scope selected for each booking."
          />
          ...
          <div className="mt-[var(--ui-space-8)] flex flex-wrap items-center gap-[var(--ui-space-3)]">
            ...
            <a
              ...
              className="flex h-12 w-12 items-center justify-center rounded-[var(--ui-radius-lg)] bg-success text-success-foreground shadow-[var(--ui-shadow-sm)] transition hover:brightness-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
            >
