...
export const NOTIFICATION_TEMPLATE_CATALOG: ReadonlyArray<{
  ...
  { key: "booking_payment_processing", channel: "email", wiredAtRuntime: false },
  { key: "booking_payment_processing", channel: "sms", wiredAtRuntime: false },
  { key: "payment_link", channel: "email", wiredAtRuntime: false },
  { key: "payment_link", channel: "sms", wiredAtRuntime: false },
  { key: "booking_recovery_saved_quote", channel: "email", wiredAtRuntime: false },
  { key: "booking_assigned", channel: "email", wiredAtRuntime: false },
  { key: "booking_assigned", channel: "whatsapp", wiredAtRuntime: false },
  { key: "job_completed", channel: "email", wiredAtRuntime: false },
  { key: "booking_cancelled", channel: "email", wiredAtRuntime: false },
  { key: "booking_cancelled", channel: "sms", wiredAtRuntime: false },
  { key: "booking_rescheduled", channel: "email", wiredAtRuntime: false },
  { key: "booking_rescheduled", channel: "sms", wiredAtRuntime: false },
  { key: "reminder_2h", channel: "email", wiredAtRuntime: false },
  { key: "reminder_2h", channel: "sms", wiredAtRuntime: false },
  { key: "booking_reminder_24h", channel: "email", wiredAtRuntime: false },
  { key: "review_prompt", channel: "email", wiredAtRuntime: false },
  ...
  { key: "admin_payment_confirmed", channel: "email", wiredAtRuntime: false },
] as const;
