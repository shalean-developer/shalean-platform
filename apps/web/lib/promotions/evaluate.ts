...
export function mapPromotionRow(raw: Record<string, unknown>): PromotionRow {
  return {
    ...
    show_featured_card: Boolean(raw.show_featured_card),
    show_dashboard_card: Boolean(raw.show_dashboard_card),
    show_booking_banner: Boolean(raw.show_booking_banner),
    ...
    terms_html: (raw.terms_html as string | null) ?? null,
    qr_code_data_url: (raw.qr_code_data_url as string | null) ?? null,
    content_generated_at: (raw.content_generated_at as string | null) ?? null,
    template_key: (raw.template_key as string | null) ?? null,
