...
export const getFreeQuoteButtonClass = {
  ...
  navCompact:
    "inline-flex min-h-11 items-center rounded-lg border border-blue-200 px-3 py-2 text-xs font-semibold text-blue-700 transition hover:bg-blue-50 sm:text-sm",
  onDark:
