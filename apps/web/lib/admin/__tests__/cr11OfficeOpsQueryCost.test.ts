...
describe("CR-11 Office Ops query cost contract", () => {
  ...
  it("aggregates analytics in a caller-privileged RPC restricted to service_role", () => {
    const migration = read(
      "../../supabase/migrations/20260911205010_cr11e_owner_command_centre_analytics_rollup.sql",
    );
