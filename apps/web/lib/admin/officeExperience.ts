...
export type OfficeAccessPolicy = {
  path: string;
  anyOf: AdminPermission[];
  audience: OfficeRoleKey[];
};

/**
 * Single source of truth for page visibility, sidebar navigation and command search.
 * More-specific prefixes must appear before broader prefixes.
 */
export const OFFICE_ACCESS_POLICIES: OfficeAccessPolicy[] = [
  { path: "/office/payouts/approvals", anyOf: ["payout.approve"], audience: ["owner", "manager"] },
  ...
  { path: "/office/cash-flow", anyOf: ["finance.full.view"], audience: ["owner", "manager", "finance"] },
  { path: "/office/budgets", anyOf: ["finance.full.view"], audience: ["owner", "manager", "finance"] },
  { path: "/office/booking-profitability", anyOf: ["profit.view"], audience: ["owner", "manager", "finance"] },
  { path: "/office/expenses", anyOf: ["expense.manage", "finance.full.view"], audience: ["owner", "manager", "finance"] },
  { path: "/office/recurring-expenses", anyOf: ["expense.manage", "finance.full.view"], audience: ["owner", "manager", "finance"] },
  { path: "/office/expense-vendors", anyOf: ["expense.manage", "finance.full.view"], audience: ["owner", "manager", "finance"] },
  ...
  { path: "/office/referral-finance", anyOf: ["finance.full.view"], audience: ["owner", "manager", "finance"] },
  { path: "/office/referral-reconciliation", anyOf: ["payment.reconcile"], audience: ["owner", "manager", "finance"] },
  { path: "/office/referral-fraud", anyOf: ["finance.full.view", "audit.view"], audience: ["owner", "manager", "finance"] },
  { path: "/office/invoices", anyOf: ["invoice.manage"], audience: ["owner", "manager", "finance"] },
  { path: "/office/billing", anyOf: ["invoice.manage", "integration.manage"], audience: ["owner", "manager", "finance"] },
