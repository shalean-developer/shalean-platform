...
/**
 * Documented sources of truth for Owner Command Centre KPIs.
 * Every displayed figure must map to exactly one of these.
 */
...
export type OwnerCommandCentreQuickAction = {
  id: string;
  label: string;
  href: string;
};
...
export type OwnerCommandCentrePayload = {
  ...
  businessHealth: {
    revenueTodayZar: OwnerNullableNumber;
    revenueMonthZar: OwnerNullableNumber;
    completedBookingsToday: OwnerNullableNumber;
    grossMarginCents: OwnerNullableNumber;
    netOperatingPositionCents: OwnerNullableNumber;
    previousMonthComparisonPct: OwnerNullableNumber;
  };
  cashFlow: {
    cashReceivedMonthCents: OwnerNullableNumber;
    outstandingCustomerPaymentsCents: OwnerNullableNumber;
    approvedExpensesCents: OwnerNullableNumber;
    cleanerLiabilitiesCents: OwnerNullableNumber;
    netCashPositionCents: OwnerNullableNumber;
  };
  payoutApprovals: {
    pendingApprovalAmountCents: OwnerNullableNumber;
    eligibleAmountCents: OwnerNullableNumber;
    pendingProposalCount: OwnerNullableNumber;
    overdueApprovalCount: OwnerNullableNumber;
  };
  security: {
    criticalAuditAlerts: OwnerNullableNumber;
    recentPermissionChanges: OwnerNullableNumber;
    failedLoginAlerts: OwnerNullableNumber;
    pendingAccessReviews: OwnerNullableNumber;
  };
  todaySnapshot: {
    totalBookings: OwnerNullableNumber;
    completed: OwnerNullableNumber;
    inProgress: OwnerNullableNumber;
    pendingOrUnallocated: OwnerNullableNumber;
    cancelled: OwnerNullableNumber;
    revenueZar: OwnerNullableNumber;
    cleanerEarningsCents: OwnerNullableNumber;
    estimatedGrossProfitCents: OwnerNullableNumber;
    lateOrExceptionCount: OwnerNullableNumber;
  };
  summaries: {
    customers: {
      retentionPct: OwnerNullableNumber;
      totalBookingsWindow: OwnerNullableNumber;
      avgBookingValueZar: OwnerNullableNumber;
    };
    workforce: {
      activeCleaners: OwnerNullableNumber;
      availableToday: OwnerNullableNumber;
      pendingApplications: OwnerNullableNumber;
    };
    bookingServices: Array<{ label: string; count: number; revenueZar: number | null }>;
    financial: {
      customerRevenueCents: OwnerNullableNumber;
      grossMarginCents: OwnerNullableNumber;
      netProfitCents: OwnerNullableNumber;
      outstandingCustomerPaymentsCents: OwnerNullableNumber;
    };
  };
...
/** Owner experience requires both company-admin permissions (same as inferOfficeRole "owner"). */
export function canAccessOwnerCommandCentre(
  permissions: ReadonlySet<string> | readonly string[],
): boolean {
  return inferOfficeRole(permissions) === "owner";
}

export function ownerQuickActionsForPermissions(
  permissions: ReadonlySet<string>,
): OwnerCommandCentreQuickAction[] {
...
/** Empty shell used when a section loader fails — fields stay null (never coerced to 0). */
export function emptyOwnerCommandCentreSections(): Pick<
  OwnerCommandCentrePayload,
  "businessHealth" | "cashFlow" | "payoutApprovals" | "security" | "todaySnapshot" | "summaries"
> {
  return {
    businessHealth: {
      revenueTodayZar: null,
      revenueMonthZar: null,
      completedBookingsToday: null,
      grossMarginCents: null,
      netOperatingPositionCents: null,
      previousMonthComparisonPct: null,
    },
    cashFlow: {
      cashReceivedMonthCents: null,
      outstandingCustomerPaymentsCents: null,
      approvedExpensesCents: null,
      cleanerLiabilitiesCents: null,
      netCashPositionCents: null,
    },
    payoutApprovals: {
      pendingApprovalAmountCents: null,
      eligibleAmountCents: null,
      pendingProposalCount: null,
      overdueApprovalCount: null,
    },
    security: {
      criticalAuditAlerts: null,
      recentPermissionChanges: null,
      failedLoginAlerts: null,
      pendingAccessReviews: null,
    },
    todaySnapshot: {
      totalBookings: null,
      completed: null,
      inProgress: null,
      pendingOrUnallocated: null,
      cancelled: null,
      revenueZar: null,
      cleanerEarningsCents: null,
      estimatedGrossProfitCents: null,
      lateOrExceptionCount: null,
    },
    summaries: {
