 ...
 * - **`resolveCleanerDashboardEarningsCents`** is the shared per-cleaner display amount for cleaner dashboard
 *   earnings and office payout allocations (summary slice, then booking-column fallback).
 *
