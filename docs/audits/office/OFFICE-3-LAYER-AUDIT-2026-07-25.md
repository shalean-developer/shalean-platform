...
> **Production run** against `https://shalean.co.za` using merged infrastructure
> `abab7b1fe9c4e2186405a489aa2610f6ab80216a`.
> `OFFICE_AUDIT_READ_ONLY=true`. No production data or business logic modified.
> No credentials created or exposed.
> This does **not** certify `/office` as 100% accurate.
...
| Field | Value |
| --- | --- |
| Generated | 2026-07-25T16:41:57.960Z |
