...
| EO package tip (verify CI / preview against this SHA) | `e54764c6b5fb3c3cc8f902b1f0cd62df18d37c2d` |
...
> **Authorize EO review of PR #89 tip `e54764c6b5fb3c3cc8f902b1f0cd62df18d37c2d` on `seo/fix-001-002-prod-ready` (SEO-FIX-001/002 production package + Window Cleaning homepage CTA removal at `6e6a1429225a0513e0bb58ba688247e367104ab5`). Preview/CI verification against that exact tip SHA only. Do not authorize production merge, production deploy, GSC writes, sitemap submission, indexing requests, DNS/Plesk changes, or booking-v2 catalog expansion for window cleaning.**
