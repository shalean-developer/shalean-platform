-- Prepaid online checkout uses payment_status='pending' (awaiting Paystack).
-- Monthly-profile customers were incorrectly rewritten to pending_monthly on insert,
-- which blocked Paystack finalize from marking payment_status='success'.
...
comment on function public.bookings_after_write_monthly_invoice() is
  'Monthly invoice attach for monthly customers / explicit monthly flags. Preserves prepaid payment_status=pending for Paystack checkout.';
