-- Idempotent: adds deposit tracking for admin "Deposit only" flow.
-- Safe alongside 20260907_bookings_deposit_paid_cents.sql if that revision already ran elsewhere.
